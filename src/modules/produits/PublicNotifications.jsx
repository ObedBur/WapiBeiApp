...
import { Bell, ArrowRight, Star, Tag } from '../../components/Icons';
...
export default function PublicNotifications() {
  ...
  const loadNotifications = async () => {
    ...
    try {
      ...
      const response = await fetch(`${BASE}/api/publicNotifications`);
      if (!response.ok) throw new Error(`Erreur lors du chargement: ${response.status}`);
